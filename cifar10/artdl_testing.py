...
if __name__ == "__main__":
    ...
    resnet18.load_state_dict(torch.load("./model/resnet18_cifar10_model.pth"))
    resnet18.eval()
    # print(art_hash_distance(resnet18, 'P', 'ED'))

    resnet20 = ResNet20().to(device)
    resnet20.load_state_dict(torch.load("./model/resnet20_cifar10_model.pth"))
    resnet20.eval()
    # print(art_hash_distance(resnet20, 'P', 'ED'))
