...
def loadData(dataset_path):
    ...
    seed_inputs = os.path.join(dataset_path, "D:/CarDetection/Car-Recognition-master/cifar10/dataset/cifar10_images")
...
def addNoise(filelist):
    ...
    dir_path = "D:/CarDetection/Car-Recognition-master/cifar10/dataset/cifar10_images"
