...
def loadData(dataset_path):
    ...
    seed_inputs = os.path.join(dataset_path, "D:/CarDetection/Car-Recognition-master/mnist/dataset/mnist_images")
...
def addNoise(filelist):
    ...
    dir_path = "D:/CarDetection/Car-Recognition-master/mnist/dataset/mnist_images"
